...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.60afe795aa33dc1ff0805d81bf607ff880bbdbe76a2c9814f16d8d1655fcdc03.js',function(){input.required=false;search();});}
