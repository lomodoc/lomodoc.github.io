...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.c882c8d6074e6a56bbf8218628494280333123cc8cd2dcd0359e1fa0a84e6a7e.js',function(){input.required=false;search();});}
