...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.db4330d2e2b1748854ca2f1c71ec4b09773df783af9bbbde8ed1ab7856a9b2e7.js',function(){input.required=false;search();});}
