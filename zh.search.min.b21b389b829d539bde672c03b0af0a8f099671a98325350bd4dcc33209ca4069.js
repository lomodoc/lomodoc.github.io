...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.4ed8e29a62964d5a650ebc6efb0f79ca10d6c1b028c43a00bd3a5b7823cb38c5.js',function(){input.required=false;search();});}
