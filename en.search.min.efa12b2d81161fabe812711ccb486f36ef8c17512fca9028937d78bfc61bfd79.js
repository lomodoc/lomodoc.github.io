...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fa2a3961ced753ca62b715e376019e2bf5a27c5a88485468672f614c1af7b1b5.js',function(){input.required=false;search();});}
