...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.ce902c7815011d23ccbc16217569285cd7e13ddd65f7862e26fc9273cb74bfda.js',function(){input.required=false;search();});}
