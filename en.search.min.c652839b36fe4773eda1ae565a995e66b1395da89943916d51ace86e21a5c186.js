...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f08226c6becc4e742eae6937c9d9f022c0c7da45d2382a8a8615a8db76c8dba3.js',function(){input.required=false;search();});}
