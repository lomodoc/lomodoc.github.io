...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.ed14321611a7d5bc8569a3772e0d1b16feb80c148a51f1e68ab9d49a1a3d9f8d.js',function(){input.required=false;search();});}
