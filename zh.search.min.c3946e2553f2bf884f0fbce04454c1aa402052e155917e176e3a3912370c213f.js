...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.fd2e876f15fc1af4c89e0618c3bba8d9d2a5f0ee0b07377125356603d200aef9.js',function(){input.required=false;search();});}
