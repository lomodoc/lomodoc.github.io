...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.980bf24736befdd40fb4dee7ca50bcd5a6a9ade926d0826b0b41a996f29dd1c6.js',function(){input.required=false;search();});}
