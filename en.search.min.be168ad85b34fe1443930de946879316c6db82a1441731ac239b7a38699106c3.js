...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6a730ca875c3626ba56f91b70d7e0e8e98a39c81f7c8d0acbaa686329ed1c161.js',function(){input.required=false;search();});}
