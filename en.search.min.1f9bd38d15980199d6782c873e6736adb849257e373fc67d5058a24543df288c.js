...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2da30910aa56a535533619d30729a8d60413164a8dcb57ef02adcb864814de92.js',function(){input.required=false;search();});}
