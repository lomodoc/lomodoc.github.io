...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.9515585cef7d91db5e96ddaca0aebca9f06e652c31acd90504a4322b2adb4197.js',function(){input.required=false;search();});}
