...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.e5511dfe48df130a325e0fcdc034313264f3cb9818d9cdfb394727275101821a.js',function(){input.required=false;search();});}
