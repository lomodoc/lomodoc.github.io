...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fcde9a2910a970bc2e0d54f767c39afaef9093898ebaa6874619e45ae730dcde.js',function(){input.required=false;search();});}
