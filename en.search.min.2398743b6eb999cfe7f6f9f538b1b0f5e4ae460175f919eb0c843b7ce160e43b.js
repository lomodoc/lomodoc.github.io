...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9fffca2ddb36c267ba7698b85d55d954e3284e0e2a1d4a52db34bfd950ecf979.js',function(){input.required=false;search();});}
