...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.49a965aa1c62a1411384c8205f20a7b5662a75282e4cb5f86a486469841bcef5.js',function(){input.required=false;search();});}
