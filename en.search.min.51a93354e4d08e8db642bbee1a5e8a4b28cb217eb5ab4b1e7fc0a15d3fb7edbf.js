...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c322b01a7a2368cf2c79fde1d850877947357dcaf64fb88d87c1c81a6925f66d.js',function(){input.required=false;search();});}
