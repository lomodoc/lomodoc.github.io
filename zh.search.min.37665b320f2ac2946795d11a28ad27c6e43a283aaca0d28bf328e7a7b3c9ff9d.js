...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.ec2add04d8e2181739da7530f4fd5bb0befd00957ef85a0f463353b39abf90f7.js',function(){input.required=false;search();});}
