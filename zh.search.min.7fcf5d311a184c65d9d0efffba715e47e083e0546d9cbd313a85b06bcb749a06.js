...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.79c99be67b88e6b8ab3e079ed8bf4dab9d1ca54a0d81997ddb2bfb2e1212c71a.js',function(){input.required=false;search();});}
