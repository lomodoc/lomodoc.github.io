...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.6f64ee763ff6e48ff3b40410ab513ae405fb88a7a8f5e2cfb7dcaa5491dacb24.js',function(){input.required=false;search();});}
